...
public class DeepGames{
    ...
    if any exceptions come into picture then it will call the same function again.
    it will repeat utill you give coreect input
    ...
    */
    ...
    /*
    it will take name as input from the user and update the information in palyer array accordingly
    */
    ...
    /*
    this function calls the playgame function for each user.
    so that each player games in turns
    */
    ...
    /*
    After the game was done by all the players
    this function will display the scores of players in descending order
    */
