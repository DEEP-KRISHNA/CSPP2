...
public interface ListInterface<E extends Comparable<E>> {
     ...
     * @throws InvalidException if the index is not valid
     */
     ...
     * @return the last index of the item from this list otherwise returns -1
     */
    public int lastIndexOf(E item);

    /**
     * This method returns the number of occurances of the item in this list.
     * 
     ...
     */
    public void add(int index, E item) throws InvalidException;
}